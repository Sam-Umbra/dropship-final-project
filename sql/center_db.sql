...
CREATE TABLE IF NOT EXISTS `center_db`.`addresses` (
  ...
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  `address_type` ENUM('RESIDENTIAL', 'COMMERCIAL', 'OTHER') NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `center_db`.`suppliers` (
  ...
  `contact_phone` VARCHAR(13) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `center_db`.`product_variants` (
  ...
  `supplier_product_id` VARCHAR(100) NULL DEFAULT NULL,
