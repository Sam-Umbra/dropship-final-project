...
('GameHouse Importadora', '98.765.432/0001-55', TRUE, 'NORMAL', NULL, 'ACTIVE', 'vendas@gamehouse.com', '+5511988888888', 8.0);
...
INSERT INTO products (product_id, product_name, description, price, stock, status, img_url, discount, supplier_id) VALUES
    ...
    (2, 'Smartphone X', 'Smartphone moderno com câmera avançada e alto desempenho', 2200.00, 20, 'ACTIVE', 'https://d3qoj2c6mu9s8x.cloudfront.net/Custom/Content/Products/40/06/4006975_smartphone-apple-iphone-x-5-8-camera-12mp-dual-frontal-7mp-com-ios-11-prata-256gb_m2_637223855454369999.webp', 12, 2),
    (3, 'Fone de Ouvido Bluetooth', 'Fone de ouvido sem fio com bateria de longa duração', 150.00, 50, 'ACTIVE', 'https://m.media-amazon.com/images/I/51olNZRjn+L._AC_SY300_SX300_.jpg', 25, 2);
