...
-- ======================================
CREATE DATABASE IF NOT EXISTS center_db CHARACTER
SET
...
VALUES
    (
        ...
        '$2a$10$odd29HJ1aXK/5MIYHO2rbu9O1apPF03KRmhx940iy3GZ5Oamwpg4y',
        NOW (),
        '47389692855',
        '+5511987654321',
        'ACTIVE',
...
VALUES
    (
        'TechMax Distribuidora',
        '12.345.678/0001-99',
        TRUE,
        'OFFICIAL',
        'jdbc:mysql://db.techmax.com/tech_db',
        'ACTIVE',
        'contato@techmax.com',
        '+5511999999999',
        12.5
...
INSERT INTO
    supplier_user (supplier_id, user_id, association_date)
VALUES
    (1, 2, NOW ()),
    (1, 3, NOW ());
...
VALUES
    (
        1,
        'Notebook Gamer',
        'Notebook de alto desempenho para jogos',
        4500.00,
        10,
        'ACTIVE',
        'https://m.media-amazon.com/images/I/51Wv-tEUn6L._AC_SX679_.jpg',
        10,
        1
    ),
    (
        2,
        'Smartphone X',
        'Smartphone moderno com câmera avançada e alto desempenho',
        2200.00,
        20,
        'ACTIVE',
    ...
    (
        ...
        'Fone de ouvido sem fio com bateria de longa duração',
        150.00,
        50,
        'ACTIVE',
        'https://m.media-amazon.com/images/I/51olNZRjn+L._AC_SY300_SX300_.jpg',
        25,
        1
    );
...
VALUES
    ...
    (
        3,
        'ROLE_SUPPLIER_PRIMARY',
        'Primary supplier role with full supplier permissions',
        NOW ()
    ),
    (
        4,
        'ROLE_SUPPLIER',
        'Regular supplier role with limited supplier permissions',
        NOW ()
    );
...
INSERT INTO
    users_roles (user_id, role_id, assigned_at)
VALUES
    (1, 1, NOW ()),
    (1, 2, NOW ()),
    (2, 2, NOW ()),
